...
def create_targets(latents, latents_x0, actions, model: NOW):
    ...
    bst_latents_target = latents[:bootstrap_batch_size]
    ...
    latents_target_ = torch.cat([bst_latents_target,latents[:bst_size_data]],dim=0)
