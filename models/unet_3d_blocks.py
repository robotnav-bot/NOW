...
from .attention import SpatialTransformer3D, TemporalTransformer3D
...
class UNetMidBlock3DCrossAttn(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, cond_frame = 0, return_attn = False):
...
class CrossAttnUpBlock3D(nn.Module):
    ...
    def forward(self, hidden_states, res_hidden_states_tuple, temb=None, encoder_hidden_states=None, cond_frame = 0, return_attn = False):
        for resnet, attn, temp_attn in zip(self.resnets, self.attentions, self.temporal_attentions):
