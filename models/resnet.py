...
class ResnetBlock3D(nn.Module):
    def __init__(
        ...
        *,
        ...
        if self.up:
            self.upsample = Upsample3D(in_channels, use_conv=True)
        elif self.down:
            self.downsample = Downsample3D(in_channels, use_conv=True, padding=1, name="op")
