...
class DinoV2ExtractFeatures:
    ...
    def __init__(self, dino_model: _DINO_V2_MODELS, layer: int, 
        ...
        os.environ['TORCH_HOME'] = '/root/workspace/pretrained_weights'

        self.dino_model: nn.Module = torch.hub.load(
                '/root/workspace/code/Navigation_worldmodel/worldmodelnav/models_dist/EffoNav/dinov2', dino_model,source='local', force_reload=False)
